...
local function connect (conn, data)
   ...
   conn:on ("receive",
      function (cn, req_data)
         ...
         --cn:send ("<h1>Hello World</h1> from ESP8266 and NodeMCU!!")
         cn:send ("<!DOCTYPE html><html><head></head><body><center><h1>EcoCitizens</h1><br><h2>Testing</h2><br>")
         cn:send (temp .."</center></body>")
